...
pub fn initialize_bodies_spiro(num_bodies_added: &usize,
    ...
    for i in 0..*num_bodies_added {
        let angular_position: f64 = (TAU * i as f64 + initial_angular_offset) / *num_bodies_added as f64;
        ...
        if let CenterObjectValues::CenterObjectExists(center_mass, center_position) = center_object_values {
            orbital_speed = calculate_orbital_speed(&center_mass, &center_position, body_position);
        } else {
            orbital_speed = 0.0;
        }
